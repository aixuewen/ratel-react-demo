...
class Device extends React.Component {
  ...
  render() {
    ...
    const loop = data => data.map((item) => {
      ...
      if (item.deviceManufacturer === "Xiaomi") {
        imgSrc = require('assets/logo/xiaomi.jpeg')
      } else if (item.deviceManufacturer === "OPPO") {
        imgSrc = require('assets/logo/oppo.jpeg')
      } else if (item.deviceManufacturer === "vivo") {
        imgSrc = require('assets/logo/vivo.jpeg')
      } else if (item.deviceManufacturer === "HUAWEI") {
        imgSrc = require('assets/logo/huawei.jpeg')
      } else if (item.deviceManufacturer === "360") {
